...
describe('botao de retornar a pagina anterior', () => {

    it('retorno da descrição a todos os produtos', () => {
        cy.visit('/allshop')
        cy.get(':nth-child(4) > a > .sc-hBUSln').click()
        cy.get('.sc-gWXbKe > svg').click()
    })
    it('retorno do carrinho cheio para descrição do produto', () => {
        cy.visit('/allshop')
        cy.get(':nth-child(4) > a > .sc-hBUSln').click()
        ...
        cy.get('.sc-bBHxTw > svg').click()
    })
    it('retorno do carrinho vazio para allshop', () => {
        cy.visit('/')
